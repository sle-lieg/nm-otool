...
/*   Updated: 2018/09/25 17:35:15 by sle-lieg         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	read_sym_table_b(t_file *file) // add strsize, the size of string table to check if the file is valid
{
	...
	print_list_big(file, file->symboles);
}